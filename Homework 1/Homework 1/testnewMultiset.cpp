...
int main()
{
	...
	*/
	...
	assert(value1 == 44 && count1 == 1 && value2 == 23 && count2 == 1 && d.size() == 6 && d.uniqueSize() == 6);

	ItemType v1;
	int c1 = e.get(3, v1);
	ItemType v2;
	int c2 = e.get(1, v2);
	assert(v1 == 45 && c1 == 1 && v2 == 34 && c2 == 1 && e.size() == 5 && e.uniqueSize() == 5);
	...
	assert(val1 == 22 && ct1 == 3 && val2 == 34 && ct2 == 2 && val3 == 11 && ct3 == 3 && d.size() == 14 && d.uniqueSize() == 7);
