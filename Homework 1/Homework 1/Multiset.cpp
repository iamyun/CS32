...
//	}
//
//	if (elem_size < DEFAULT_MAX_ITEMS)	//if value is new to the set, increase unique size of the size by 1 after adding the new value, set count of value to 1
//	{
...
//{
//	//create temporary set for storing original set
//	ItemType tempV;
//	int tempC;
...
//		tempC = elem[i].count;
//
//		elem[i].value = other.elem[i].value;
//		elem[i].count = other.elem[i].count;
//
//		other.elem[i].value = tempV;
//		other.elem[i].count = tempC;
//	}
//
...
//		}
//		else if (pos == -1 && other.elem_size < DEFAULT_MAX_ITEMS)
//		{
